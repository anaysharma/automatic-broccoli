...
eval("\n\nmodule.exports = function (url, options) {\n  if (!options) {\n    options = {};\n  }\n\n  if (!url) {\n    return url;\n  }\n\n  url = String(url.__esModule ? url.default : url); // If url is already wrapped in quotes, remove them\n\n  if (/^['\"].*['\"]$/.test(url)) {\n    url = url.slice(1, -1);\n  }\n\n  if (options.hash) {\n    url += options.hash;\n  } // Should url be wrapped?\n  // See https://drafts.csswg.org/css-values-3/#urls\n\n\n  if (/[\"'() \\t\\n]|(%20)/.test(url) || options.needQuotes) {\n    return \"\\\"\".concat(url.replace(/\"/g, '\\\\\"').replace(/\\n/g, \"\\\\n\"), \"\\\"\");\n  }\n\n  return url;\n};\n\n//# sourceURL=webpack://automatic-broccoli/./node_modules/css-loader/dist/runtime/getUrl.js?");
...
eval("module.exports = __webpack_require__.p + \"a5d2e4fc4b448ae80fa9.jpg\";\n\n//# sourceURL=webpack://automatic-broccoli/./src/images/background.jpg?");
...
eval("module.exports = __webpack_require__.p + \"aadadb0721078f933aac.png\";\n\n//# sourceURL=webpack://automatic-broccoli/./src/images/chef.png?");
